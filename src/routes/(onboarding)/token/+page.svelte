...
>
  ...
  <button bind:this={submitButton} class="hidden"></button>
  {#if isSubmitting}
  <div class="relative col-span-full w-20 h-20 mx-auto">
    <div class="radial-progress absolute inset-0 text-base-300" style="--value:100;"></div>
    <div class="radial-progress absolute inset-0 animate-spin" style="--value:25;"></div>
  </div>
  {/if}
