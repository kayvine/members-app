...
<main class="card col-span-2 bg-base-100 shadow-lg">
  <div class="card-body">
    <h2 class="card-title">
      {#if $subscription.firstName}Welcome, {$subscription.firstName}
        {$subscription.lastName}{:else}Welcome!{/if}
    </h2>
    ...
    {:else}
      <p>
        To become a member you will need to provide the necesary information. At the end of the form you will
        be able to view and sign the documents to complete your subscription.
      </p>
      <div class="card-actions justify-end">
        <button type="button" on:click={() => goto('/subscription/personal')} class="btn btn-primary"
